  ...
  Future<void> _updateStatus(String documentId, String newStatus) async {
    try {
      ...
      if (newStatus == 'paid') {
        ...
        final document = await _firestore.collection('DepositDetails').doc(documentId).get();
        ...
        FirebaseApi.sendMessage('Deposit Request Accepted', 'Your deposit request of ${document['User Diamond']} diamond has been approved', userToken);
              ...
              Expanded(
                child: Container(
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    stream: _firestore
                        .collection('DepositDetails')
                        .where('Status', whereIn: ['unpaid','reject']).snapshots(),
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                            ...
                            trailing: DropdownButton<String>(
                              ...
                              items: <String>['unpaid', 'paid','reject']
                                  .map((String value) {
                            ...
                            onTap: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => ScreenShortScreen(
                                        screen_short: document['user_photo'],
                                      )));
